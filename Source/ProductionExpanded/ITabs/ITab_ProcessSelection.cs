  ...
  public class ITab_ProcessSelection : ITab
  {
    ...
    private void DrawBillRow(Rect rect, ProcessBill bill, int index)
    {
      ...
      if (Widgets.ButtonText(modeRect, modeLabel))
      {
        ...
        {
          options.Add(new FloatMenuOption("Do Until X", () => bill.repeatMode = ProcessRepeatMode.DoUntillX));
        }
    ...
    private string GetRepeatModeLabel(ProcessBill bill)
    {
      ...
      {
        case ProcessRepeatMode.Forever: return "Do Forever";
        case ProcessRepeatMode.DoXTimes: return "Do X times";
        case ProcessRepeatMode.DoUntillX: return "Do until you have X";
